...
file_path = "/mofem_install/jupyter/thomas/mfront_interface/DP_hyperboloidal.res"
c = 0.3
phi = 0.26
a = 1
PLOT_DIR = "/mofem_install/jupyter/thomas/mfront_interface/mtest_plots/DruckerPragerHyperboloidal"
