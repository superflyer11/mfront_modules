...
file_path = "/mofem_install/jupyter/thomas/mfront_interface/DP_hyperboloidal_old.res"
c = 0.3
phi = 0.26
a = 1
PLOT_DIR = "/mofem_install/jupyter/thomas/mfront_interface/mtest_plots/DruckerPragerHyperboloidalOld"
...
"""
Html_file= open(f"{PLOT_DIR}/Desmos3D_raw_old.html","w")
...
"""
Html_file= open(f"{PLOT_DIR}/Desmos3D_raw_plastic_strain_old.html","w")
Html_file.write(interacative_html_js)
Html_file.close()
